document.addEventListener("DOMContentLoaded", function () {
    ...
    // Show Locations button event listener
    const showLocationsButton = document.getElementById('showLocationsButton');
    showLocationsButton.addEventListener('click', function () {
        // Hide the button after it is clicked
        showLocationsButton.style.display = 'none';

        // Show the map and locations
